...
namespace WEB_SHOW_WRIST_STRAP.Models.Entities
{
    public partial class DataPointContext : DbContext
    {
        ...
        public virtual DbSet<TotalNg> TotalNg { get; set; } = null!;
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseSqlServer("Data Source=DRIVERDELL-NHIE\\MAY1;Initial Catalog=DataPoint;User ID=sa;Password=Adgjmptw96;Trust Server Certificate=True");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<TotalNg>(entity =>
            {
                entity.ToTable("Total_NG");
                ...
                entity.Property(e => e.MinSpect)
                      .HasColumnName("min_spect")
                      .IsRequired();

                entity.Property(e => e.MaxSpect)
                      .HasColumnName("max_spect")
                      .IsRequired();
            ...
            modelBuilder.Entity<Hub>(entity =>
            {
                ...
                entity.Property(e => e.LeftCss).HasColumnName("left_css");
                ...
                entity.Property(e => e.TopCss).HasColumnName("top_css");
            });
